...
public class GitHubProjectTest {
    ...
    String sshKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIFkfCP/o18JJPVSOQ2PliMWUlUlE2gDU/P9SmaNs1o9B";
    int sshKeyId;

    // Request specification
    RequestSpecification requestSpec = new RequestSpecBuilder().
            setBaseUri("https://api.github.com/user/keys").
            addHeader("Authorization", "token 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").
