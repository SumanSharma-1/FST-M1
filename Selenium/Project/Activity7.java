...
public class Activity7 {
	...
	public void postJob() throws InterruptedException {
		...
		driver.findElement(By.id("create_account_email")).sendKeys("sumanjitan@abcde.com");
		driver.findElement(By.id("job_title")).sendKeys("FST");
		WebElement dropdown= driver.findElement(By.id("job_type"));
		Select select= new Select(dropdown);
		select.selectByIndex(0);
		
		driver.findElement(By.id("application")).sendKeys("sumajitn@abcd.com");
		...
		driver.findElement(By.xpath("//body[@id='tinymce']")).sendKeys("This is my project");
		Thread.sleep(1000);
